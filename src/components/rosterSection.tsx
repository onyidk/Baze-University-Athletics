    ...
    <section className="py-12 px-8 bg-gray-50" id="roster">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {players.map((player) => (
            <div key={player.number} className="bg-white border border-gray-300 rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-4">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div><strong>Class:</strong> {player.academicYear}</div>
                  <div><strong>Height:</strong> {player.height}</div>
                  <div><strong>Hometown:</strong> {player.hometown}</div>
                  <div><strong>Last School:</strong> {player.lastSchool}</div>
                </div>
                <button 
